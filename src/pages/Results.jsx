...
function Results() {
    ...
    return (
        <FadeUp>
            <section className="px-6 lg:px-20 py-8 lg:py-16">
                <div className="flex flex-col gap-8 lg:gap-12">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                        {/* Top Match */}
                        <div className="col-span-12 lg:col-span-7 flex flex-col h-full">
                            {/* Header */}
                            <div className="bg-primary rounded-t-lg px-6 py-8 lg:py-11">
                                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-start gap-8 lg:gap-16">
                                    <div className="flex flex-col gap-5 items-center">
                                        <p className="text-white text-h1 font-heading pt-2 lg:pt-0">{topMatch.score}%</p>
                            ...
                            {/* Content */}
                            <div className="bg-card rounded-b-lg border border-primary px-6 py-8 lg:py-12 flex-1 flex flex-col justify-between">
                                <div className="flex flex-col gap-8 lg:gap-12">
                                    ...
                                    <div className="flex flex-col">
                                        {[
                                            ...
                                            <div
                                                key={label}
                                                className={`flex justify-between py-4 lg:py-6
                        ...
                        <div className="col-span-12 lg:col-span-5 relative">
                            <img src={blurBg} alt="View More Schools" className="w-full h-100 lg:h-full lg:max-h-240 object-cover rounded-lg" />
                            {/* Modal */}
